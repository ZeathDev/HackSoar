package dev.hacksoar.pvp.clickgui;

import dev.hacksoar.HackSoar;
import dev.hacksoar.api.events.EventTarget;
import dev.hacksoar.api.events.impl.EventRenderShadow;
import dev.hacksoar.pvp.GuiSearchField;
import dev.hacksoar.pvp.clickgui.category.Category;
import dev.hacksoar.pvp.clickgui.category.CategoryManager;
import dev.hacksoar.pvp.clickgui.category.impl.CosmeticCategory;
...
public class ClickGUI extends GuiScreen{
	...
	public void onGuiClosed() {
		if(HackSoar.instance.fileManager != null) {
			HackSoar.instance.configManager.save();
		}
	}
