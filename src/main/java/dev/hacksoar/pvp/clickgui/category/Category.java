...
public class Category {
	...
	public float getX() {
		return HackSoar.instance.guiManager.getClickGUI().getX();
	}
	
	public float getY() {
		return HackSoar.instance.guiManager.getClickGUI().getY();
	}
	
	public float getWidth() {
		return HackSoar.instance.guiManager.getClickGUI().getWidth();
	}
	
	public float getHeight() {
		return HackSoar.instance.guiManager.getClickGUI().getHeight();
	}
}
