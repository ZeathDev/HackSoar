...
public class GuiPleaseLogin extends GuiScreen{
	...
	public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						close = true;
						HackSoar.instance.accountManager.isFirstLogin = false;
		...
		if(MouseUtils.isInside(mouseX, mouseY, x + 35, y + 91, 100, 20)) {
			...
			close = true;
			HackSoar.instance.accountManager.isFirstLogin = false;
			HackSoar.instance.accountManager.setCurrentAccount(HackSoar.instance.accountManager.getAccountByUsername(username));
			HackSoar.instance.accountManager.save();
		}
