    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = FontUtils.regular20.drawString(s1, (float)l, (float)i1 + HackSoar.instance.guiManager.getClickGUI().searchAnimation.getValue(), ColorUtils.getFontColor(2).getRGB());
            }
            ...
            {
                j1 =  FontUtils.regular20.drawString(s.substring(j), (float)j1, (float)i1 + HackSoar.instance.guiManager.getClickGUI().searchAnimation.getValue(),  ColorUtils.getFontColor(2).getRGB());
            }
            ...
            if (flag1)
            {
                ...
                {
                	 FontUtils.regular20.drawString("_", (float)k1, (float)i1 + HackSoar.instance.guiManager.getClickGUI().searchAnimation.getValue(),  ColorUtils.getFontColor(2).getRGB());
                }
            }
