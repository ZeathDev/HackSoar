...
public class HypixelMod extends Mod {
	...
	public void onTick(EventTick event) {
		if(HackSoar.instance.settingsManager.getSettingByName(this, "Auto Tip").getValBoolean()) {
	...
	public void onUpdate(EventUpdate event) {
		...
		int delay = (int) HackSoar.instance.settingsManager.getSettingByName(this, "Delay").getValDouble();
