...
import dev.hacksoar.api.events.impl.EventRenderHitbox;
...
public class HitboxMod extends Mod {
	...
	public void onRenderHitbox(EventRenderHitbox event) {
		...
		boolean boundingBox = HackSoar.instance.settingsManager.getSettingByName(this, "Bounding box").getValBoolean();
		boolean eyeHeight = HackSoar.instance.settingsManager.getSettingByName(this, "Eye Height").getValBoolean();
		boolean lookVector = HackSoar.instance.settingsManager.getSettingByName(this, "Look Vector").getValBoolean();
		int lineWidth = HackSoar.instance.settingsManager.getSettingByName(this, "Line Width").getValInt();
