...
public class Mod {
	...
	public void addBooleanSetting(String name, Mod mod, boolean toggle) {
		HackSoar.instance.settingsManager.addSetting(new Setting(name, mod, toggle));
	}
	
	public void addModeSetting(String name, Mod mod, String defaultMode, ArrayList<String> options) {
		HackSoar.instance.settingsManager.addSetting(new Setting(name, mod, defaultMode, options));
	}
	
	public void addSliderSetting(String name, Mod mod, double defaultValue, double minValue, double maxValue, boolean intValue) {
		HackSoar.instance.settingsManager.addSetting(new Setting(name, mod, defaultValue, minValue, maxValue, intValue));
	}
	
	public void drawBackground(float x, float y, float width, float height) {
		int opacity = (int) (HackSoar.instance.settingsManager.getSettingByClass(HUDMod.class, "Opacity").getValDouble() * 255);
		int radius = HackSoar.instance.settingsManager.getSettingByClass(HUDMod.class, "Radius").getValInt();
		String mode = HackSoar.instance.settingsManager.getSettingByClass(HUDMod.class, "Design").getValString();
		
		if(HackSoar.instance.settingsManager.getSettingByClass(HUDMod.class, "Background").getValBoolean()) {
			switch(mode) {
				case "Color":
