...
public class ScoreboardMod extends Mod {
	...
	public void onRenderScoreboard(EventRenderScoreboard event) {
		...
		boolean showNumber = HackSoar.instance.settingsManager.getSettingByName(this, "ShowNumber").getValBoolean();
	...
	public void onRenderShadow(EventRenderShadow event) {
        ...
        if (scoreobjective1 != null && HackSoar.instance.settingsManager.getSettingByName(this, "Shadow").getValBoolean())
        {
