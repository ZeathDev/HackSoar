...
import dev.hacksoar.pvp.management.mods.impl.MusicInfoMod;
...
public class Music {
	...
	public void playMusic() {
		...
		if(HackSoar.instance.modManager.getModByName("Music Info").isToggled()) {
	...
	public void setVolume() {
		mediaPlayer.setVolume(HackSoar.instance.settingsManager.getSettingByClass(ClientMod.class, "Volume").getValDouble());
	}
