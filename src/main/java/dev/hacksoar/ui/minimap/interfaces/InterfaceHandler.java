package dev.hacksoar.ui.minimap.interfaces;

import dev.hacksoar.HackSoar;
import dev.hacksoar.pvp.management.mods.impl.MinimapMod;
import dev.hacksoar.ui.minimap.XaeroMinimap;
import dev.hacksoar.ui.minimap.minimap.Minimap;
    ...
    public static void load() {
        InterfaceHandler.minimap = new Minimap(new Interface("gui.xaero_minimap", 128, 128) {
            ...
            public void drawInterface(final int width, final int height, final int scale, final float partial) {
                ...
                InterfaceHandler.mc.ingameGUI.drawTexturedModalRect(HackSoar.instance.modManager.getModByClass(MinimapMod.class).getX(), HackSoar.instance.modManager.getModByClass(MinimapMod.class).getY(), 0, 0, (int)((mapW / 2 + 1) / sizeFix), (int)((mapH / 2 + 1) / sizeFix));
