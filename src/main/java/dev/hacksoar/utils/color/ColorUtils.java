package dev.hacksoar.utils.color;
...
public class ColorUtils {
	...
	private static Color getRawBackgroundColor(int id) {
		...
		boolean dark = HackSoar.instance.settingsManager.getSettingByClass(ClientMod.class, "DarkMode").getValBoolean();
	...
	public static Color getClientColor(int index, int alpha) {
		...
		for(AccentColor c : HackSoar.instance.colorManager.getColors()) {
			if(c.equals(HackSoar.instance.colorManager.getClientColor())) {
