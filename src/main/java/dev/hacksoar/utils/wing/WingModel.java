package dev.hacksoar.utils.wing;

import dev.hacksoar.HackSoar;
import dev.hacksoar.pvp.management.mods.impl.WingsMod;
...
public class WingModel extends ModelBase implements LayerRenderer<AbstractClientPlayer>{
    ...
    public void renderWing(AbstractClientPlayer player) {
        if (HackSoar.instance.modManager.getModByClass(WingsMod.class).isToggled()) {
