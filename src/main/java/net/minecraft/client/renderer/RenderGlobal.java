...
import dev.hacksoar.pvp.management.mods.impl.BlockOverlayMod;
...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    public void drawSelectionBox(EntityPlayer player, MovingObjectPosition movingObjectPositionIn, int execute, float partialTicks) {
        if (execute == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (HackSoar.instance.modManager.getModByClass(BlockOverlayMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(BlockOverlayMod.class, "Outline").getValBoolean()) {
            ...
            GlStateManager.depthMask(false);
            if (HackSoar.instance.modManager.getModByClass(BlockOverlayMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(BlockOverlayMod.class, "Depth").getValBoolean()) {
            ...
            if (block.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos)) {
                ...
                if (HackSoar.instance.modManager.getModByClass(BlockOverlayMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(BlockOverlayMod.class, "Fill").getValBoolean()) {
                    ColorUtils.setColor(new Color(ColorUtils.getClientColor(0).getRed(), ColorUtils.getClientColor(0).getGreen(), ColorUtils.getClientColor(0).getBlue(), (int) (HackSoar.instance.settingsManager.getSettingByClass(BlockOverlayMod.class, "Opacity").getValFloat() * 255)).getRGB());
