...
import dev.hacksoar.pvp.management.mods.impl.MinimalBobbingMod;
import dev.hacksoar.pvp.management.mods.impl.MinimalDamageShakeMod;
import dev.hacksoar.pvp.management.mods.impl.MotionBlurMod;
import dev.hacksoar.pvp.management.mods.impl.OldAnimationsMod;
import dev.hacksoar.utils.shader.MotionBlurUtils;
...
*/
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (HackSoar.instance.moduleManager.getModule("NoHurtCam").toggled) {
            return;
        }
    ...
    private void orientCamera(float partialTicks) {
        ...
        if(HackSoar.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(OldAnimationsMod.class, "Sneak").getValBoolean() && entity instanceof EntityPlayer) {
    ...
    public void setupCameraTransform(float partialTicks, int pass) {
        ...
        if(!HackSoar.instance.modManager.getModByClass(MinimalDamageShakeMod.class).isToggled()) {
            this.hurtCameraEffect(f);
        }

        if (this.mc.gameSettings.viewBobbing) {
            // this.setupViewBobbing(partialTicks);
            if(!HackSoar.instance.modManager.getModByClass(MinimalBobbingMod.class).isToggled()) {
    ...
    public void renderHand(float p_renderHand_1_, int p_renderHand_2_, boolean p_renderHand_3_, boolean p_renderHand_4_, boolean p_renderHand_5_) {
        if(mc.thePlayer != null && HackSoar.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled() &&
                HackSoar.instance.settingsManager.getSettingByClass(OldAnimationsMod.class, "Block Hit").getValBoolean()
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.theWorld != null) {
                ...
                if (OpenGlHelper.shadersSupported) {
                    ...
                    if(HackSoar.instance.modManager.getModByClass(MotionBlurMod.class).isToggled()) {
                        if (motionBlur != null){
