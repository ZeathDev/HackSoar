...
import dev.hacksoar.pvp.hooks.RenderTNTPrimedHook;
import dev.hacksoar.pvp.management.mods.impl.TNTTimerMod;
...
public class RenderTNTPrimed extends Render<EntityTNTPrimed> {
    ...
    public void doRender(EntityTNTPrimed entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if(HackSoar.instance.modManager.getModByClass(TNTTimerMod.class).isToggled()) {
