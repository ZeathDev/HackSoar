...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
    ...
    public boolean shouldCombineTextures() {
        if(HackSoar.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled() &&
                HackSoar.instance.settingsManager.getSettingByClass(OldAnimationsMod.class, "Armor Damage").getValBoolean()) {
            return true;
        }
        return false;
    }
