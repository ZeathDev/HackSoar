...
import dev.hacksoar.pvp.management.mods.impl.HypixelMod;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    protected void renderOffsetLivingLabel(AbstractClientPlayer entityIn, double x, double y, double z, String str, float p_177069_9_, double p_177069_10_) {
        ...
        boolean toggle = HackSoar.instance.modManager.getModByClass(HypixelMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(HypixelMod.class, "Level Head").getValBoolean();
