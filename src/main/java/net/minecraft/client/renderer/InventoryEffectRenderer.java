...
import dev.hacksoar.pvp.management.mods.impl.InventoryMod;
...
public abstract class InventoryEffectRenderer extends GuiContainer {
   ...
   /* protected void updateActivePotionEffects() {
    ...
    {
        if (!this.mc.thePlayer.getActivePotionEffects().isEmpty()){
            if(HackSoar.instance.modManager.getModByClass(InventoryMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(InventoryMod.class, "Prevent Potion Shift").getValBoolean()) {
                this.guiLeft = (this.width - this.xSize) / 2;
            }else {
                this.guiLeft = 160 + (this.width - this.xSize - 200) / 2;
            }
