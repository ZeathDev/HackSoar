...
public class GuiChat extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if(HackSoar.instance.modManager.getModByClass(ChatMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(ChatMod.class, "Bar Animation").getValBoolean()) {
