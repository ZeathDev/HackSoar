...
public class GuiNewChat extends Gui {
    ...
    private void updatePercentage(long diff) {
        if (percentComplete < 1) {
            percentComplete += (HackSoar.instance.settingsManager.getSettingByClass(ChatMod.class, "Smooth Speed").getValDouble() / 1000) * (float) diff;
        }
    ...
    public void drawChat(int updateCounter) {
        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                ...
                float y = 0;
                if (HackSoar.instance.modManager.getModByClass(ChatMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(ChatMod.class, "Smooth").getValBoolean() && !this.isScrolled) {
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                boolean transparent = !HackSoar.instance.modManager.getModByClass(ChatMod.class).isToggled() || (HackSoar.instance.modManager.getModByClass(ChatMod.class).isToggled() &&
                                        !HackSoar.instance.settingsManager.getSettingByClass(ChatMod.class, "Transparent background").getValBoolean());
