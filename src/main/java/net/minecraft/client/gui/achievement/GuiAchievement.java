...
public class GuiAchievement extends Gui {
    ...
    public void updateAchievementWindow() {
        if(HackSoar.instance.modManager.getModByClass(OverlayEditorMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(OverlayEditorMod.class, "Disable Achievements").getValBoolean()) {
            return;
        }
