...
import dev.hacksoar.api.events.impl.EventRenderScoreboard;
import dev.hacksoar.api.events.impl.EventRenderSelectedItem;
import dev.hacksoar.pvp.hooks.GuiIngameHook;
import dev.hacksoar.pvp.management.mods.impl.HotbarMod;
import dev.hacksoar.pvp.management.mods.impl.OldAnimationsMod;
import dev.hacksoar.pvp.management.mods.impl.OverlayEditorMod;
...
public class GuiIngame extends Gui {
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            boolean animation = HackSoar.instance.settingsManager.getSettingByClass(HotbarMod.class, "Animation").getValBoolean();
            int animationSpeed = HackSoar.instance.settingsManager.getSettingByClass(HotbarMod.class, "Speed").getValInt();
            String mode = HackSoar.instance.settingsManager.getSettingByClass(HotbarMod.class, "Design").getValString();
            ...
            if(HackSoar.instance.modManager.getModByClass(HotbarMod.class).isToggled()) {
    ...
    private void renderPlayerStats(ScaledResolution scaledRes) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            for (int i6 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; i6 >= 0; --i6)
            {
                ...
                if (flag)
                {
                    if((!HackSoar.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled()) || (HackSoar.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled()) && !HackSoar.instance.settingsManager.getSettingByClass(OldAnimationsMod.class, "Health").getValBoolean()) {
                        if (i6 * 2 + 1 < j)
                        {
    ...
    private void renderPumpkinOverlay(ScaledResolution scaledRes) {
        if(HackSoar.instance.modManager.getModByClass(OverlayEditorMod.class).isToggled()) {
            if(HackSoar.instance.settingsManager.getSettingByClass(OverlayEditorMod.class, "Hide Pumpkin").getValBoolean()) {
                return;
            }
        }
        GlStateManager.disableDepth();
