...
import dev.hacksoar.pvp.management.mods.impl.TabEditorMod;
...
public class GuiPlayerTabOverlay extends Gui {
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (flag) {
                    ...
                    if(HackSoar.instance.modManager.getModByClass(TabEditorMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(TabEditorMod.class, "Remove Player Head").getValBoolean()) {
                        entityplayer = null;
                    }
    ...
    private boolean showHeads() {
        return !(HackSoar.instance.modManager.getModByClass(TabEditorMod.class).isToggled() && HackSoar.instance.settingsManager.getSettingByClass(TabEditorMod.class, "Remove Player Head").getValBoolean());
    }
}
