...
import dev.hacksoar.pvp.GuiSplashScreen;
import dev.hacksoar.pvp.hooks.MinecraftHook;
import dev.hacksoar.pvp.management.mods.impl.FPSLimiterMod;
import dev.hacksoar.pvp.management.mods.impl.FPSSpooferMod;
import dev.hacksoar.pvp.management.mods.impl.HitDelayFixMod;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(HackSoar.instance.getName() + " Client v" + HackSoar.instance.getVersion() + " for " + "Minecraft 1.8.9");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if(guiScreenIn instanceof GuiMainMenu) {
            displayGuiScreen(HackSoar.instance.guiManager.getGuiMainMenu());
        }
    }
...
//                logger.error(i + ": " + s);
    ...
    public int getLimitFramerate() {
        if(HackSoar.instance.modManager.getModByClass(FPSLimiterMod.class).isToggled()) {
    ...
    private void clickMouse() {
        if(HackSoar.instance.modManager.getModByClass(HitDelayFixMod.class).isToggled()) {
            leftClickCounter = 0;
        }
    ...
    public static int getDebugFPS() {
        if(HackSoar.instance.modManager.getModByClass(FPSSpooferMod.class).isToggled()) {
            return HackSoar.instance.settingsManager.getSettingByClass(FPSSpooferMod.class, "Multiplication").getValInt() * debugFPS;
        }
        return debugFPS;
//        return debugFPS;
    }
