...
import dev.hacksoar.api.events.impl.EventJump;
import dev.hacksoar.api.events.impl.EventLivingUpdate;
import dev.hacksoar.pvp.management.mods.impl.SlowSwingMod;
...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if(HackSoar.instance.modManager.getModByClass(SlowSwingMod.class).isToggled()) {
            return ((int) HackSoar.instance.settingsManager.getSettingByClass(SlowSwingMod.class, "Delay").getValDouble());
        }
