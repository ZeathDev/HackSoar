...
import dev.hacksoar.manages.component.impl.SmoothCameraComponent;
import dev.hacksoar.modules.impl.utilty.Scaffold;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public float getAIMoveSpeed() {
        if (this instanceof EntityPlayerSP) {
            final Scaffold scaffold = (Scaffold) HackSoar.instance.moduleManager.getModule("Scaffold");
