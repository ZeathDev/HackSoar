...
import dev.hacksoar.pvp.management.mods.impl.ClearGlassMod;
...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        return !HackSoar.instance.modManager.getModByClass(ClearGlassMod.class).isToggled() && shouldSideBeRenderedAfter(worldIn, pos, side);
    }
