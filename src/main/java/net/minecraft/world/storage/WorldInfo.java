...
import dev.hacksoar.pvp.management.mods.impl.TimeChangerMod;
...
public class WorldInfo {
    ...
    public void setWorldTime(long time) {
        boolean toggle = HackSoar.instance.modManager.getModByClass(TimeChangerMod.class).isToggled();
        long customTime = (long) HackSoar.instance.settingsManager.getSettingByClass(TimeChangerMod.class, "Time").getValDouble();
