...
import net.mforge.common.property.IUnlistedProperty;
...
public class Reflector {
    ...
    public static ReflectorClass BlamingTransformer = new ReflectorClass("net.mforge.fml.common.asm.transformers.BlamingTransformer");
    public static ReflectorMethod BlamingTransformer_onCrash = new ReflectorMethod(BlamingTransformer, "onCrash");
    public static ReflectorClass ChunkWatchEvent_UnWatch = new ReflectorClass("net.mforge.event.world.ChunkWatchEvent$UnWatch");
    ...
    public static ReflectorClass CoreModManager = new ReflectorClass("net.mforge.fml.relauncher.CoreModManager");
    public static ReflectorMethod CoreModManager_onCrash = new ReflectorMethod(CoreModManager, "onCrash");
    public static ReflectorClass DimensionManager = new ReflectorClass("net.mforge.common.DimensionManager");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.mforge.client.event.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.mforge.client.event.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_CameraSetup = new ReflectorClass("net.mforge.client.event.EntityViewRenderEvent$CameraSetup");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.mforge.client.event.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass Event = new ReflectorClass("net.mforge.fml.common.eventhandler.Event");
    public static ReflectorMethod Event_isCanceled = new ReflectorMethod(Event, "isCanceled");
    public static ReflectorClass EventBus = new ReflectorClass("net.mforge.fml.common.eventhandler.EventBus");
    public static ReflectorMethod EventBus_post = new ReflectorMethod(EventBus, "post");
    public static ReflectorClass Event_Result = new ReflectorClass("net.mforge.fml.common.eventhandler.Event$Result");
    ...
    public static ReflectorClass ExtendedBlockState = new ReflectorClass("net.mforge.common.property.ExtendedBlockState");
    ...
    public static ReflectorClass FMLClientHandler = new ReflectorClass("net.mforge.fml.client.FMLClientHandler");
    ...
    public static ReflectorClass FMLCommonHandler = new ReflectorClass("net.mforge.fml.common.FMLCommonHandler");
    ...
    public static ReflectorClass ForgeEventFactory = new ReflectorClass("net.mforge.event.ForgeEventFactory");
    ...
    public static ReflectorClass ForgeHooks = new ReflectorClass("net.mforge.common.ForgeHooks");
    ...
    public static ReflectorClass ForgeHooksClient = new ReflectorClass("net.mforge.client.ForgeHooksClient");
    ...
    public static ReflectorClass ForgeModContainer = new ReflectorClass("net.mforge.common.ForgeModContainer");
    ...
    public static ReflectorClass GuiModList = new ReflectorClass("net.mforge.fml.client.GuiModList");
    public static ReflectorConstructor GuiModList_Constructor = new ReflectorConstructor(GuiModList, new Class[] {GuiScreen.class});
    public static ReflectorClass IColoredBakedQuad = new ReflectorClass("net.mforge.client.model.IColoredBakedQuad");
    public static ReflectorClass IExtendedBlockState = new ReflectorClass("net.mforge.common.property.IExtendedBlockState");
    public static ReflectorMethod IExtendedBlockState_getClean = new ReflectorMethod(IExtendedBlockState, "getClean");
    public static ReflectorClass IModel = new ReflectorClass("net.mforge.client.model.IModel");
    public static ReflectorMethod IModel_getTextures = new ReflectorMethod(IModel, "getTextures");
    public static ReflectorClass IRenderHandler = new ReflectorClass("net.mforge.client.IRenderHandler");
    public static ReflectorMethod IRenderHandler_render = new ReflectorMethod(IRenderHandler, "render");
    public static ReflectorClass ItemModelMesherForge = new ReflectorClass("net.mforge.client.ItemModelMesherForge");
    ...
    public static ReflectorClass LightUtil = new ReflectorClass("net.mforge.client.model.pipeline.LightUtil");
    ...
    public static ReflectorClass Loader = new ReflectorClass("net.mforge.fml.common.Loader");
    ...
    public static ReflectorClass mforge = new ReflectorClass("net.mforge.common.mforge");
    public static ReflectorField mforge_EVENT_BUS = new ReflectorField(mforge, "EVENT_BUS");
    public static ReflectorClass mforgeClient = new ReflectorClass("net.mforge.client.mforgeClient");
    public static ReflectorMethod mforgeClient_getRenderPass = new ReflectorMethod(mforgeClient, "getRenderPass");
    public static ReflectorMethod mforgeClient_onRebuildChunk = new ReflectorMethod(mforgeClient, "onRebuildChunk");
    public static ReflectorClass ModContainer = new ReflectorClass("net.mforge.fml.common.ModContainer");
    public static ReflectorMethod ModContainer_getModId = new ReflectorMethod(ModContainer, "getModId");
    public static ReflectorClass ModelLoader = new ReflectorClass("net.mforge.client.model.ModelLoader");
    ...
    public static ReflectorClass ModelLoader_VanillaLoader = new ReflectorClass("net.mforge.client.model.ModelLoader$VanillaLoader");
    ...
    public static ReflectorClass RenderBlockOverlayEvent_OverlayType = new ReflectorClass("net.mforge.client.event.RenderBlockOverlayEvent$OverlayType");
    ...
    public static ReflectorClass RenderingRegistry = new ReflectorClass("net.mforge.fml.client.registry.RenderingRegistry");
    ...
    public static ReflectorClass RenderItemInFrameEvent = new ReflectorClass("net.mforge.client.event.RenderItemInFrameEvent");
    ...
    public static ReflectorClass RenderLivingEvent_Pre = new ReflectorClass("net.mforge.client.event.RenderLivingEvent$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Post = new ReflectorClass("net.mforge.client.event.RenderLivingEvent$Post");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Pre = new ReflectorClass("net.mforge.client.event.RenderLivingEvent$Specials$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Post = new ReflectorClass("net.mforge.client.event.RenderLivingEvent$Specials$Post");
    ...
    public static ReflectorClass SplashScreen = new ReflectorClass("net.mforge.fml.client.SplashProgress");
    public static ReflectorClass WorldEvent_Load = new ReflectorClass("net.mforge.event.world.WorldEvent$Load");
    ...
    public static boolean postForgeBusEvent(Object event) {
        if (event == null) {
            ...
            Object object = getFieldValue(mforge_EVENT_BUS);
